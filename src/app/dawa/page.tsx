...
const DawaAcademy = () => {
  ...
  const fetchAttendanceSummary = async () => {
    try {
      ...
      // Filter data for Dawa Academy only
      const filteredData: AttendanceSummary = {
        ...
        sickStudents: data.sickStudents.filter((student: Student) => student.campus === 'dawa academy')
      };
  ...
  const filterMealData = (mealData: any) => {
    ...
    return {
      ...mealData,
      presentStudents: mealData.presentStudents.filter((student: Student) => student.campus === 'dawa academy'),
      absentStudents: mealData.absentStudents.filter((student: Student) => student.campus === 'dawa academy'),
      present: mealData.presentStudents.filter((student: Student) => student.campus === 'dawa academy').length,
      absent: mealData.absentStudents.filter((student: Student) => student.campus === 'dawa academy').length,
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
                  ...
                  {isLoading ? (
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {mealTimes.map((meal) => {
                        ...
                        const campusTotal = mealData?.campusTotals?.['dawa academy'] || 0;
        ...
        <TableGrid 
          onOpenTableDetails={handleOpenTableDetails} 
