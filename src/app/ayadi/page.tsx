...
const Tables = () => {
  ...
  const fetchAttendanceSummary = async () => {
    try {
      ...
      // Filter data for Ayadi campus only
      const filteredData: AttendanceSummary = {
        ...
        sickStudents: data.sickStudents.filter((student: Student) => student.campus === 'ayadi')
      };
  ...
  const filterMealData = (mealData: any) => {
    ...
    return {
      ...mealData,
      presentStudents: mealData.presentStudents.filter((student: Student) => student.campus === 'ayadi'),
      absentStudents: mealData.absentStudents.filter((student: Student) => student.campus === 'ayadi'),
      present: mealData.presentStudents.filter((student: Student) => student.campus === 'ayadi').length,
      absent: mealData.absentStudents.filter((student: Student) => student.campus === 'ayadi').length,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Ayadi</h1>
                  ...
                  {isLoading ? (
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {mealTimes.map((meal) => {
                        ...
                        const campusTotal = mealData?.campusTotals?.['ayadi'] || 0;
        ...
        <TableGrid onOpenTableDetails={handleOpenTableDetails} selectedMeal={selectedMeal} selectedCampus="ayadi" />
        <TableModal
