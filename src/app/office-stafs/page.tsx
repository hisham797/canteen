...
const Tables = () => {
  ...
  const fetchAttendanceSummary = async () => {
    try {
      ...
      // Filter data for Office Staff campus only
      const filteredData: AttendanceSummary = {
        ...
        sickStudents: data.sickStudents.filter((student: Student) => student.campus === 'office stafs')
      };
  ...
  const filterMealData = (mealData: any) => {
    ...
    return {
      ...mealData,
      presentStudents: mealData.presentStudents.filter((student: Student) => student.campus === 'office stafs'),
      absentStudents: mealData.absentStudents.filter((student: Student) => student.campus === 'office stafs'),
      present: mealData.presentStudents.filter((student: Student) => student.campus === 'office stafs').length,
      absent: mealData.absentStudents.filter((student: Student) => student.campus === 'office stafs').length,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Office Staff Campus</h1>
        ...
        {isDataHidden ? (
          ...
          <>
            ...
            <div className="grid gap-4 mb-6 grid-cols-1 md:grid-cols-2">
              {/* Present Staff Summary */}
              <Card className="bg-green-50 border-green-200">
                <CardContent className="pt-6">
                  <h3 className="font-medium text-lg mb-3">Present Staff</h3>
                  {isLoading ? (
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {mealTimes.map((meal) => {
                        ...
                        const campusTotal = mealData?.campusTotals?.['office stafs'] || 0;
              ...
              {/* Absent Staff Summary */}
              <Card className="bg-red-50 border-red-200">
                <CardContent className="pt-6">
                  <h3 className="font-medium text-lg mb-3">Absent Staff</h3>
                  {isLoading ? (
                    <div className="flex items-center justify-center py-4">
        ...
        <TableGrid onOpenTableDetails={handleOpenTableDetails} selectedMeal={selectedMeal} selectedCampus="office stafs" />
        <TableModal
        ...
        <Dialog open={isDetailsDialogOpen} onOpenChange={setIsDetailsDialogOpen}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle>
                {selectedMealDetails?.meal} - {selectedMealDetails?.type === 'present' ? 'Present' : selectedMealDetails?.type === 'sick' ? 'Sick' : 'Absent'} Staff
              </DialogTitle>
            </DialogHeader>
